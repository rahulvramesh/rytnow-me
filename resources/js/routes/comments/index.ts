...
*/
export const show = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
show.url = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            task: args[0],
            comment: args[1],
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
show.get = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
show.head = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
const showForm = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
showForm.get = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: show.url(args, options),
    method: 'get',
})
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
showForm.head = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
export const update = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
update.put = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/api/v1/tasks/{task}/comments/{comment}'
*/
updateForm.put = (args: { task: number | { id: number }, comment: number | { id: number } } | [task: number | { id: number }, comment: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
