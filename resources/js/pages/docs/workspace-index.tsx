...
import { FileText, FolderKanban, LayoutList, List, Search, X } from 'lucide-react';
...
export default function WorkspaceDocsIndex({ documents, projects }: Props) {
    ...
    const documentsByProject = useMemo(() => {
        const grouped: Record<number, { project: DocProject; documents: Document[] }> = {};
        filteredDocuments.forEach((doc) => {
            if (!grouped[doc.project_id]) {
                grouped[doc.project_id] = {
                    project: doc.project || { id: doc.project_id, name: 'Unknown', status: 'active' },
                    documents: [],
                };
            }
