...
*/
export const toggle = (args: { task: number | { id: number }, subtask: number | { id: number } } | [task: number | { id: number }, subtask: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/api/v1/tasks/{task}/subtasks/{subtask}/toggle'
*/
toggle.url = (args: { task: number | { id: number }, subtask: number | { id: number } } | [task: number | { id: number }, subtask: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            task: args[0],
            subtask: args[1],
...
* @route '/api/v1/tasks/{task}/subtasks/{subtask}/toggle'
*/
toggle.patch = (args: { task: number | { id: number }, subtask: number | { id: number } } | [task: number | { id: number }, subtask: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggle.url(args, options),
    method: 'patch',
})
...
* @route '/api/v1/tasks/{task}/subtasks/{subtask}/toggle'
*/
const toggleForm = (args: { task: number | { id: number }, subtask: number | { id: number } } | [task: number | { id: number }, subtask: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/v1/tasks/{task}/subtasks/{subtask}/toggle'
*/
toggleForm.patch = (args: { task: number | { id: number }, subtask: number | { id: number } } | [task: number | { id: number }, subtask: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: toggle.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
