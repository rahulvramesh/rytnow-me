...
/**
* @see \App\Http\Controllers\Api\V1\WorkspaceController::members
* @see app/Http/Controllers/Api/V1/WorkspaceController.php:77
* @route '/api/v1/workspaces/{workspace}/members'
*/
...
const WorkspaceController = { index, store, show, update, destroy, members }
