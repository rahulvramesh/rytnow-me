...
/**
* @see \App\Http\Controllers\SprintController::addTasks
* @see app/Http/Controllers/SprintController.php:208
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
export const addTasks = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addTasks.url(args, options),
    method: 'post',
})
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
addTasks.url = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            project: args[0],
            sprint: args[1],
    ...
    return addTasks.definition.url
            .replace('{project}', parsedArgs.project.toString())
            .replace('{sprint}', parsedArgs.sprint.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
addTasks.post = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addTasks.url(args, options),
    method: 'post',
})
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
const addTasksForm = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: addTasks.url(args, options),
    method: 'post',
})
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
addTasksForm.post = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: addTasks.url(args, options),
    method: 'post',
})

addTasks.form = addTasksForm

/**
* @see \App\Http\Controllers\SprintController::removeTasks
* @see app/Http/Controllers/SprintController.php:235
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
export const removeTasks = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: removeTasks.url(args, options),
    method: 'delete',
})

removeTasks.definition = {
    methods: ["delete"],
    url: '/projects/{project}/sprints/{sprint}/tasks',
} satisfies RouteDefinition<["delete"]>
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
removeTasks.url = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            project: args[0],
            sprint: args[1],
    ...
    return removeTasks.definition.url
            .replace('{project}', parsedArgs.project.toString())
            .replace('{sprint}', parsedArgs.sprint.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
removeTasks.delete = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: removeTasks.url(args, options),
    method: 'delete',
})
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
const removeTasksForm = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: removeTasks.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
* @route '/projects/{project}/sprints/{sprint}/tasks'
*/
removeTasksForm.delete = (args: { project: number | { id: number }, sprint: number | { id: number } } | [project: number | { id: number }, sprint: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: removeTasks.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
removeTasks.form = removeTasksForm

const SprintController = { index, create, store, backlog, show, edit, update, destroy, addTasks, removeTasks }
